...
parser.add_argument("--initial_epoch",type=int,default=0,help = "When using a pretranined model, the total number of epochs on which the model is already trained")
...
def create_model(opt):
    ...
    seq.add(tfkl.ConvLSTM2D(filters=60, kernel_size=(3, 3),
